...
public class ArrayListPersonalizado<T> extends ListValidation implements List<T> {
    ...
    public ArrayListPersonalizado(int initialCapacity) {
        this(initialCapacity, Boolean.TRUE);
    }

    public ArrayListPersonalizado(int initialCapacity, boolean resizable) {
